...
public class ForrgetPassword {
	...
	@FindBy (xpath="(//input[@type='text'])[1]") private WebElement EnterPAN;
	@FindBy (xpath="(//form//label) [3]") private WebElement EmailRadioB1;
	@FindBy (xpath="(//form//label) [4]") private WebElement SmsRadioB;
	@FindBy (xpath="(//input[@type='text'])[2]") private WebElement EnterEmail;
	@FindBy (xpath="(//input[@type='text'])[3]") private WebElement EnterCapcha;
	...
	public ForrgetPassword(WebDriver driver){
